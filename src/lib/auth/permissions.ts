...
export const PERMISSIONS = {
  ...
  badLoads: {
    view: "bad_loads.view",
    create: "bad_loads.create",
    edit: "bad_loads.edit",
    delete: "bad_loads.delete",
  },
  busWash: {
    view: "bus_wash.view",
    edit: "bus_wash.edit",
  ...
  readerCodes: {
    view: "reader_codes.view",
    create: "reader_codes.create",
    edit: "reader_codes.edit",
    delete: "reader_codes.delete",
  },
  users: {
    view: "users.view",
    create: "users.create",
...
> = {
  ...
  [PERMISSIONS.badLoads.create]: [PERMISSIONS.badLoads.view],
  [PERMISSIONS.badLoads.edit]: [PERMISSIONS.badLoads.view],
  [PERMISSIONS.badLoads.delete]: [PERMISSIONS.badLoads.view],
  ...
  [PERMISSIONS.readerCodes.create]: [PERMISSIONS.readerCodes.view],
  [PERMISSIONS.readerCodes.edit]: [PERMISSIONS.readerCodes.view],
  [PERMISSIONS.readerCodes.delete]: [PERMISSIONS.readerCodes.view],
